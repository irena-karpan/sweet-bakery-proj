import{a as p,i as E,S as T,P as x,N as O,r as R,A as re,b as V,c as F}from"./assets/vendor-Cee3kg8f.js";(function(){const t=document.createElement("link").relList;if(t&&t.supports&&t.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const c of i.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&s(c)}).observe(document,{childList:!0,subtree:!0});function o(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=o(n);fetch(n.href,i)}})();p.defaults.baseURL="https://deserts-store.b.goit.study/api/";async function oe(){return(await p.get("desserts",{params:{page:1,limit:8,type:"popular"}})).data.desserts}const N="/sweet-bakery-proj/assets/sprite-Bt9wopdv.svg",S=document.querySelector(".popular-swiper .swiper-wrapper"),se=document.querySelector(".loader-container"),ne=document.querySelector(".slider-controls");function ie(e,t){const o=e.map(({_id:s,image:n,name:i,price:c,category:u,description:P})=>`
  ...
  `}function Me(e){return e.map(({author:t,description:o,rate:s})=>`
      ...
      `).join("")}function qe(){document.querySelectorAll(".feedback-rating").forEach(t=>{const o=Number(t.dataset.rating)||0;R({element:t,max:5,rating:o,starSize:20,step:.5,readOnly:!0})})}function $e(){H||(H=new T(".feedback-swiper",{modules:[O,x],slidesPerView:1,spaceBetween:16,navigation:{prevEl:".feedback-button-prev",nextEl:".feedback-button-next"},pagination:{el:".feedback-pagination",clickable:!0,dynamicBullets:!0},breakpoints:{768:{slidesPerView:3,spaceBetween:24},1440:{slidesPerView:3,spaceBetween:24}}}))}async function Ae(){m==null||m.classList.remove("hidden"),f==null||f.classList.add("is-hidden"),g==null||g.classList.add("is-hidden");try{const e=await _e();if(!e||!e.length){console.warn("Отримано порожній масив відгуків");return}I&&(I.innerHTML=Me(e)),qe(),$e(),f==null||f.classList.remove("is-hidden"),g==null||g.classList.remove("is-hidden")}catch(e){console.error("Помилка завантаження відгуків:",e),E.error({title:"Помилка",message:"Не вдалося завантажити відгуки",position:"topRight"})}finally{m==null||m.classList.add("hidden")}}Ae();document.addEventListener("DOMContentLoaded",()=>{new re(".accordion-container",{duration:300,showMultiple:!1})});const Te=document.querySelector(".burger-btn"),B=document.querySelector(".mobile-menu"),D=document.querySelector(".mobile-backdrop"),xe=document.querySelector(".mobile-close"),Oe=document.querySelectorAll(".mobile-link"),Be=document.querySelector(".mobile-logo");Be.addEventListener("click",v);function De(){B.classList.add("is-open"),D.classList.add("is-open"),document.body.classList.add("no-scroll")}function v(){B.classList.remove("is-open"),D.classList.remove("is-open"),document.body.classList.remove("no-scroll")}Te.addEventListener("click",De);xe.addEventListener("click",v);D.addEventListener("click",v);Oe.forEach(e=>{e.addEventListener("click",v)});document.addEventListener("keydown",e=>{e.key==="Escape"&&B.classList.contains("is-open")&&v()});async function Pe(e){return(await p.get(`desserts/${e}`)).data}async function Ie(e){return(await p.post("orders",e)).data}const h=document.querySelector(".modal-order"),He=document.querySelector(".order-close"),A=document.querySelector(".order-form"),G=document.querySelector(".loader-backdrop");let Q="";function Ce(e){e.closest(".form-field").classList.add("is-error"),e.classList.add("error")}function je(e){e.closest(".form-field").classList.remove("is-error"),e.classList.remove("error")}function X(e){return e.checkValidity()?(je(e),!0):(Ce(e),!1)}const Re=A.querySelectorAll("input, textarea");Re.forEach(e=>{e.addEventListener("input",()=>{X(e)})});function Ve(e){Q=e,h.classList.remove("is-hidden"),document.documentElement.classList.add("no-scroll"),document.body.classList.add("no-scroll")}function q(){h.classList.add("is-hidden"),document.documentElement.classList.remove("no-scroll"),document.body.classList.remove("no-scroll")}function Fe(){return Q}function Ne(){G.classList.remove("is-hidden")}function We(){G.classList.add("is-hidden")}He.addEventListener("click",q);h.addEventListener("click",e=>{e.target===h&&q()});document.addEventListener("keydown",e=>{const t=!h.classList.contains("is-hidden");e.key==="Escape"&&t&&q()});function ze(e){V.fire({icon:"success",title:"Заявку успішно надіслано!",text:`Номер вашого замовлення: ${e}`,confirmButtonText:"Добре"})}function Ue(e){V.fire({icon:"error",title:"Щось пішло не так",text:e,confirmButtonText:"Спробувати ще раз"})}A.addEventListener("submit",async e=>{e.preventDefault();const{username:t,phone:o,comment:s}=e.target.elements;if(![t,o,s].every(X))return;const c={name:t.value.trim(),phone:o.value.trim(),dessertId:Fe(),comment:s.value.trim()};try{Ne();const u=await Ie(c);q(),A.reset(),ze(u.orderNum)}catch{Ue("Не вдалося надіслати заявку. Спробуйте ще раз.")}finally{We()}});const d=document.querySelector(".bd-modal-desert"),w=document.querySelector(".js-modal-dynamic-content"),y=document.querySelector(".btn-modal-desert-close"),Ke=320;let C=null;document.addEventListener("click",Ye);w==null||w.addEventListener("click",Xe);function Je(){return window.innerWidth-document.documentElement.clientWidth}async function Ye(e){const t=e.target.closest(".js-open-modal");if(!t||d&&!d.classList.contains("is-hidden"))return;const o=t.dataset.id;try{const s=await Pe(o);if(!s)throw new Error("Дані відсутні");if(Ge(s),Qe(s.rate),d){const n=Je();document.documentElement.style.setProperty("--scrollbar-width",`${n}px`),d.classList.remove("is-hidden"),document.body.classList.add("no-scroll")}Ze()}catch(s){console.error("Помилка модального вікна:",s),E.error({title:"Помилка",message:"Не вдалося завантажити дані про десерт",position:"topRight"})}}function Ge(e){const{_id:t,image:o,name:s,category:n,price:i,description:c,composition:u,rate:P}=e;w.innerHTML=`
  ...
  `}function Qe(e){const t=document.querySelector("#dessert-rater");t&&R({element:t,rating:e||0,starSize:20,readOnly:!0,max:5})}function Xe(e){const t=e.target.closest(".btn-modal-desert");if(!t)return;const o=t.dataset.id;L({keepScrollLocked:!0,afterClose:()=>Ve(o)})}function Ze(){y==null||y.addEventListener("click",L),d==null||d.addEventListener("click",Z),window.addEventListener("keydown",ee)}function L({afterClose:e,keepScrollLocked:t=!1}={}){clearTimeout(C),d&&d.classList.add("is-hidden"),t||(document.body.classList.remove("no-scroll"),document.documentElement.style.setProperty("--scrollbar-width","0px")),y==null||y.removeEventListener("click",L),d==null||d.removeEventListener("click",Z),window.removeEventListener("keydown",ee),C=setTimeout(()=>{w&&(w.innerHTML=""),e==null||e()},Ke)}function Z(e){e.target===d&&L()}function ee(e){e.code==="Escape"&&L()}const et=[".hero-title",".hero-description",".hero-btn",".popular-title",".desserts__title",".desserts__description",".desserts__select-wrapper",".desserts__category",".dessert-card",".about-us-title",".about-us-text",".about-us-slider",".feedback-title",".feedback-subtitle",".feedback-card",".faq-title",".faq-item",".footer-container"];let j=null;function te(){et.forEach(e=>{document.querySelectorAll(e).forEach(t=>{t.dataset.aos||(t.dataset.aos="fade-up")})})}function tt(){clearTimeout(j),j=setTimeout(()=>{te(),F.refreshHard()},100)}window.addEventListener("load",()=>{te(),F.init({duration:600,easing:"ease-out",offset:80,once:!0,disable:()=>window.matchMedia("(prefers-reduced-motion: reduce)").matches}),new MutationObserver(tt).observe(document.body,{childList:!0,subtree:!0})});
